...
<div class="mx-auto max-w-3xl">
    ...
    <div class="mt-4">
        ...
        <p class="mt-2 text-slate-500">Create an active administrator account with full administrative access. A generated password will be emailed to the administrator.</p>
    </div>
